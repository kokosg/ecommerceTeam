...
public class Article {
	...
	public Article(int articleID,String title,String summary,boolean chosen,int flag) {
		this.articleID = articleID;
		this.title = title;
		this.summary = summary;
		this.chosen=chosen;
		this.responsAvailable = flag;
	...
	public int isResponsAvailable() {
		return responsAvailable;
	}


	public void setResponsAvailable(int responsAvailable) {
